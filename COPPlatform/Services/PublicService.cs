        ...
        public async Task<PaginationResponse<PartnerCityResponseDto>> GetPartnerCities(PartnerCityRequestDto request)
        {
            try
            {
                ...
                var cityQuery =
                   ...
                   join uc in _context.UserAssessmentMappings on c.CityID equals uc.CityID into ucg
                   from uc in ucg.DefaultIfEmpty()
                   join a in _context.Assessments on uc.UserAssessmentMappingID equals a.UserAssessmentMappingID into ag
                   ...
                   group r by new
                   {
                       ...
                       c.CityName,
                       c.Region,
                       EvaluatorCount = _context.UserAssessmentMappings
